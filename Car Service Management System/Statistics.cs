...
namespace Car_Service_Management_System
{
    public partial class Statistics : Form
    {
        ...
        private void lblLoginChange_MouseEnter(object sender, EventArgs e)
        {
            lblLoginChange.Font = new Font(lblLoginChange.Font, FontStyle.Italic | FontStyle.Underline);
        }

        private void lblLoginChange_MouseLeave(object sender, EventArgs e)
        {
            lblLoginChange.Font = new Font(lblLoginChange.Font, FontStyle.Regular);
        }

        private void lblLoginChange_Click_1(object sender, EventArgs e)
        {
            lblLoginChange.ForeColor = Color.Gold;

            if (AdminSession.isLoggedIn == true)
            {
                MessageBox.Show("Are you sure you want to change Log-In Information", "Confirm", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            ...
            {
                MessageBox.Show("Admin not Logged in. Please Login", "Error", MessageBoxButtons.OKCancel, MessageBoxIcon.Error);
