    ...
    public partial class Calender : Form
    {
        ...
        private void displaydays()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("An error occurred while displaying days: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void btnprevious_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("An error occurred while navigating to the previous month: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void btnnext_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("An error occurred while navigating to the next month: " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
