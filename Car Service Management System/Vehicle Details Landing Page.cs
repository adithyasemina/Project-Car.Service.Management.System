...
namespace Car_Service_Management_System
{
    public partial class Vehicle_Details_Landing_Page : Form
    {
        ...
        private void Vehicle_Details_Landing_Page_Load(object sender, EventArgs e)
        {
            ...
            // Changed default font styles in datagrid view
            dataGridView2.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI", 10, FontStyle.Bold);

            dataGridView2.Columns["customerId"].DefaultCellStyle.Font = new Font("Segoe UI", 9, FontStyle.Bold);
            dataGridView2.Columns["CustomerName"].DefaultCellStyle.Font = new Font("Segoe UI", 9, FontStyle.Bold);
            dataGridView2.Columns["VehicleName"].DefaultCellStyle.Font = new Font("Segoe UI", 9, FontStyle.Bold);
            dataGridView2.Columns["VehicleBrand"].DefaultCellStyle.Font = new Font("Segoe UI", 9, FontStyle.Bold);
            dataGridView2.Columns["VehicleNumber"].DefaultCellStyle.Font = new Font("Segoe UI", 9, FontStyle.Bold);
            dataGridView2.Columns["CustomerTelNumber"].DefaultCellStyle.Font = new Font("Segoe UI", 9, FontStyle.Bold);
            dataGridView2.Columns["ChassisNumber"].DefaultCellStyle.Font = new Font("Segoe UI", 9, FontStyle.Bold);
            dataGridView2.Columns["FuelType"].DefaultCellStyle.Font = new Font("Segoe UI", 9, FontStyle.Bold);
            dataGridView2.Columns["EngineType"].DefaultCellStyle.Font = new Font("Segoe UI", 9, FontStyle.Bold);
            dataGridView2.Columns["Date"].DefaultCellStyle.Font = new Font("Segoe UI", 9, FontStyle.Bold);
